...
def setup_medium(args):  
    ...
    return X, Y, Z, SX, SY, SZ, taud, taudx, taudy, T0, px0, py0, pz0, index, sx, sy, sz, rx, ry, rz, velmodel
...
class HCEikonalPINNsData(pl.LightningDataModule):
    def __init__(
        ...
        X, Y, Z, SX, SY, SZ, taud, taudx, taudy, T0, px0, py0, pz0, index, self.sx, self.sy, self.sz, rx, ry, rz, self.velmodel = setup_medium(args)
